...
public class FormatandoDatas {
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(y2 + " Sem formato + Hor�rio");
		...
		Date x3 = new Date(0L);
		System.out.println(sdf2.format(x3) + " Inicio da contagem da data em GMT"); // No Brasil o hor�rio � GMT-3

		Date x4 = new Date(1000L * 60L * 60L * 5L);
		System.out.println(sdf2.format(x4) + " Acrescentando +5 horas ao horario Default");

		// padr�o ISO8671 e classe instant
		// horario GMT
